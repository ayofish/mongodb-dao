 ...
 */
var BaseDao = exports["default"] = /*#__PURE__*/function () {
  /**
   * @constructor
   ...
   */
  function BaseDao(config, dbClient) {
  ...
  return _createClass(BaseDao, [{
     ...
     */,
    set: function set(idString) {
      if (idString instanceof _mongodb.ObjectId) {
        this._id = idString;
      } else {
        if (idString) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 9:
              ...
              _context.next = 13;
              return this.dbRef.aggregate(aggregationArr).sort(this.sort).toArray();
            case 13:
            ...
            case 16:
              ...
              this.resetOutput();
              this.error.push(_context.t0.message);
            case 20:
    ...
    key: "create",
    value: (function () {
      var _create = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
        var insertedData;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 2;
              _context2.next = 5;
              return this.dbRef.insertOne(data);
            case 5:
              insertedData = _context2.sent;
            ...
            case 9:
              ...
              this.resetOutput();
              this.error.push(_context2.t0.message);
            case 13:
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 5:
              ...
              _context3.prev = 6;
              _context3.next = 9;
              return this.dbRef.findOneAndUpdate({
                _id: this.id
              }, {
                $set: data
              });
            case 9:
              origDataRes = _context3.sent;
              this.data = [_objectSpread(_objectSpread({}, origDataRes.value), data)];
              _context3.next = 17;
              break;
            case 13:
              _context3.prev = 13;
              ...
              this.resetOutput();
              this.error.push(_context3.t0.message);
            case 17:
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 13:
              ...
              this.resetOutput();
              this.error.push(_context4.t0.message);
            case 17:
